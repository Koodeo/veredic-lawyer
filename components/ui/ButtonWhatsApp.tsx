...
export function ButtonWhatsApp({ messageKey, children, className = "" }: ButtonWhatsAppProps) {
  const whatsappUrl = `https://wa.me/${siteConfig.whatsapp.replace(/[^\d]/g, '')}?text=${encodeURIComponent(siteConfig.whatsappMessages[messageKey])}`
